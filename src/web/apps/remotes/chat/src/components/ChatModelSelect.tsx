...
export default function ChatModelSelect({
    ...
    const [selectedModel, setSelectedModel] = React.useState<string>(chatting[chatIndex].name);

    // Sync selected model to Zustand store whenever it changes
    React.useEffect(() => {
        const currentChat = chatting.find(chat => chat.name === selectedModel);
        if (currentChat) {
            setModel(chatContentID, currentChat.model);
        }
    }, [selectedModel, chatContentID, setModel]);
                ...
                <SelectValue placeholder="Select model">
                    <div className="flex items-center gap-2">
                        {selectedModel === "gpt-5-pro" && (
                            <svg xmlns="http://www.w3.org/2000/svg" strokeLinejoin="round" viewBox="0 0 16 16" height="24" width="24">
                        ...
                        {selectedModel === "claude-sonnet-4.5" && (
                            <svg fill="currentColor" fillRule="evenodd" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
